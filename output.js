{
  ...
  output: {
    path: 'E:\\Data\\codeSpace\\Work\\whatech-saas-h5\\dist',
    filename: '[name].js',
    publicPath: '',
  ...
  resolve: {
    ...
    modules: [
      'node_modules',
      'E:\\Data\\codeSpace\\Work\\whatech-saas-h5\\node_modules',
  ...
  plugins: [
    ...
    new DefinePlugin(
      {
        'process.env': {
          ...
          VUE_APP_BASE_URL: '"http://app.cmall.world"',
          BASE_URL: '""'
        }
      }
    ),
    ...
    new CopyWebpackPlugin(
      [
        {
          from: 'E:\\Data\\codeSpace\\Work\\whatech-saas-h5\\public',
          to: 'E:\\Data\\codeSpace\\Work\\whatech-saas-h5\\dist',
          toType: 'dir',
          ignore: [
            '.DS_Store'
          ]
