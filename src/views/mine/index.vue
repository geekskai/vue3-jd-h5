<template>
  <div class="mine-layout">
    ...
    <van-dialog class="node-dialog" v-model="show" confirmButtonText="我知道啦" close-on-click-overlay
      confirmButtonColor="#3A3A3A" confirm-button-color="#FCE14B" :show-cancel-button="false"
    ...
    .user-info {
      ...
      .node-info {
        ...
        .sharing-node {
          ...
          font-size: 11px;
          text-align: center;
          background: url("../../assets/image/product/sharing-node.png") no-repeat center center;
